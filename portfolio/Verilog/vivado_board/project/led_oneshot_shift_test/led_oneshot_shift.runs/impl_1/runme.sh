...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/led_oneshot_shift_test/led_oneshot_shift.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log oneshot_shift.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source oneshot_shift.tcl -notrace
