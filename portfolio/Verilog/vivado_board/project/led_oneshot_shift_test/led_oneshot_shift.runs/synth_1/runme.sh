...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/led_oneshot_shift_test/led_oneshot_shift.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oneshot_shift.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oneshot_shift.tcl
