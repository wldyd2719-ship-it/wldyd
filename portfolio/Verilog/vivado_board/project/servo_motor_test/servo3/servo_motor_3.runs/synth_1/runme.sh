...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/servo_motor_test/servo3/servo_motor_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_servo_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_servo_control.tcl
