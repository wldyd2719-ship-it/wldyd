...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/servo_motor_test/servo3/servo_motor_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_servo_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_servo_control.tcl -notrace
