...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/servo_motor_test/servo2/servo_motor_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_servor_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_servor_control.tcl -notrace
