...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/servo_motor_test/servo2/servo_motor_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_servor_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_servor_control.tcl
