...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/0408/counter2fsm_1sec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter2fsm_1sec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter2fsm_1sec.tcl
