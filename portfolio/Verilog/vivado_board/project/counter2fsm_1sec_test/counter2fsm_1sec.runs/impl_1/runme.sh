...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/counter2fsm_1sec_test/counter2fsm_1sec.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter2fsm_1sec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter2fsm_1sec.tcl -notrace
