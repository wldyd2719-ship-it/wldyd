...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/onecounter_test/one_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log one_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source one_counter.tcl -notrace
