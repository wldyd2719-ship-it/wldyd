...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/onecounter_test/one_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log one_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source one_counter.tcl
