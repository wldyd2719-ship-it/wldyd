...
module button_fnd(
    ...
    wire pulseU = (prevU) & (~debU);    //falling edge
    wire pulseD = (~prevD) & debD;      //rising edge
    ...
    always @(*) begin
        case (value)
            4'd0: fnd = 7'b100_0000;    // 7'b( gfedcba )
            4'd1: fnd = 7'b111_1001;
            4'd2: fnd = 7'b010_0100;
            4'd3: fnd = 7'b011_0000;
            4'd4: fnd = 7'b001_1001;
            4'd5: fnd = 7'b001_0010;
            4'd6: fnd = 7'b000_0010;
            4'd7: fnd = 7'b111_1000;
            4'd8: fnd = 7'b000_0000;
            4'd9: fnd = 7'b001_0000;
