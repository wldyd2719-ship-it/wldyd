...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/button_fnd_test/button_fnd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log button_fnd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source button_fnd.tcl -notrace
