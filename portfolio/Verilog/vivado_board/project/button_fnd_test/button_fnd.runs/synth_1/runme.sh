...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/button_fnd_test/button_fnd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log button_fnd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source button_fnd.tcl
