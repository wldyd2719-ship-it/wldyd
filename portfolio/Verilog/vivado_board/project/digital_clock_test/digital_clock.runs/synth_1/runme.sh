...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/digital_clock_test/digital_clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_model.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_model.tcl
