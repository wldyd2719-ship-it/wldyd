...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/digital_clock_test/digital_clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_model.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_model.tcl -notrace
