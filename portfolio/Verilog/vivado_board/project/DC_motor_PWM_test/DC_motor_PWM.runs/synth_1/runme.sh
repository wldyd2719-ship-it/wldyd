...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/DC_motor_PWM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_dc_motor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_dc_motor.tcl
