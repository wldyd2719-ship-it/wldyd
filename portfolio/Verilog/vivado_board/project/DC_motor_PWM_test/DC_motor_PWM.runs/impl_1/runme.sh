...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/DC_motor_PWM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_dc_motor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_dc_motor.tcl -notrace
