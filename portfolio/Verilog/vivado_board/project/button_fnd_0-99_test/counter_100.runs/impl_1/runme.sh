...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/button_fnd_0-99_test/counter_100.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_100.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_100.tcl -notrace
