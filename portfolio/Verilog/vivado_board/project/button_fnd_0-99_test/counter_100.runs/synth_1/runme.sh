...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/button_fnd_0-99_test/counter_100.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_100.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_100.tcl
