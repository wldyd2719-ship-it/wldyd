...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/sram_model_bd_test/sram_model_bd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sram_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sram_top.tcl -notrace
