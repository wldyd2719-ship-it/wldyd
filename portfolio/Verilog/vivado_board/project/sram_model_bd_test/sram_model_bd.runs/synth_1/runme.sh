...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/sram_model_bd_test/sram_model_bd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sram_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sram_top.tcl
