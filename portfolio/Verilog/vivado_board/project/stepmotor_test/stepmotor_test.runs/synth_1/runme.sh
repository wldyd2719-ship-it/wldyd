...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/stepmotor_test/stepmotor_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log step_motor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source step_motor.tcl
