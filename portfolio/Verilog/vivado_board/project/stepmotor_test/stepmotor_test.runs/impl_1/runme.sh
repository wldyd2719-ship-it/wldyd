...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/stepmotor_test/stepmotor_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log step_motor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source step_motor.tcl -notrace
