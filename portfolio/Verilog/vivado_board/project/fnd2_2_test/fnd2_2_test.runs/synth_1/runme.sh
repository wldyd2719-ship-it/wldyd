...
HD_PWD='C:/Users/SAMSUNG/Desktop/verilog/vivado_board/project/fnd2_2_test/fnd2_2_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fnd2_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fnd2_2.tcl
